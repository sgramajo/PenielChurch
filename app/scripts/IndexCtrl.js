...
app.config(['$translateProvider', function ($translateProvider){
    ...
    .translations('esp', {
        ...
        MINISTRY2: 'Tu tienes oportunidad para también aprender más sobre los ministerios que toma en considera la etapa de tu vida presentemente, desde ministerio de niños con <a href="' + kidsLink + '" style="color: #ff66ff; text-transform: uppercase;">SPARKS KIDS</a>, estudiantes de la intermedia hasta colegio y jóvenes adultos (20-30s) a través de <a href="' + youth + '" style="color: #00cc66; text-transform: uppercase;">LIFE YOUTH</a> MINISTRY, y hasta todos los otros adultos (30’s+) a través de nuestros ministerios de <a href="' + mensLink + '" style="color:#ff6600">HOMBRES</a>/<a href="' + womenLink + '" style="color: rgb(255,0,102)">MUJERES</a>. Te invitamos a encontrar donde mejor puede ser impactado por el propósito de Dios en tu vida!', 
        'TUESDAY': 'Martes', 
        'WEDNESDAY': 'Miercoles', 
        'SUNDAY': 'Domingo', 
        'FRIDAY': 'Viernes', 
        ...
        'PASTORISSAC': 'Que Dios te bendiga en su abundancia con todas las bendiciones que Dios ha derramado para ti en respuesta de tu fidelidad!! Mi nombre es Pastor Isaac, el Pastor Administrativo, junto a mi esposa Pastora Kelly. Ha sido una bendición experimentar todas los grandes momentos de abundancia que cada miembro de Peniel ha tenido y esperamos ansiosamente la TUYA! Dios nos ha puesto en su camino de Avivamiento por un gran propósito y no lo podemos lograr sin cada uno de ustedes o su fidelidad. Bendice como Dios te ha bendecido, con lo que tienes y veras sus maravillas cumplir su promesa para los deseo de tu corazón. El sabe lo que tu necesitas, Confía en el y el te sera fiel. Recuerda, “La voluntad de Dios no te llevará donde la gracia de Dios no te cuidará.” Bendiciones,', 
        'PASTORDANNY': 'Bendiciones! Mi nombre es Daniel pero me puedes llamar Danny. Estoy casado con mi hermosa esposa Jennifer y tenemos 3 preciosas hijas. Tenemos el privilegio de servir jovenes aqui en Peniel. Es nuestra pasión ver a las personas tener VIDA en Jesús y descubrir todo lo que él tiene para ellos. Creemos que Dios nos ha llamado para alcanzar a los jóvenes para amar, guiar, y enseñarles cómo alcanzar su potencial en Jesús. Te invitamos para tener VIDA!', 
